...
public class PrintVisitor implements Visitor{
    ...
    public void visit(EqualityExpression ee){
        ...
        for(int i=0; i<size - 1; i++){
            ee.elementAt(i).accept(this);
            out.print("==");
        }
        ee.elementAt(size-1).accept(this);
    }
    ...
    public void visit(LessThanExpression lte){
        int size = lte.size();
        for(int i=0; i<size - 1; i++){
            lte.elementAt(i).accept(this);
            out.print("<");
        }
        lte.elementAt(size-1).accept(this);
    }
    public void visit(MultExpression me){
        int size = me.size();
        for(int i=0; i<size - 1; i++){
            me.elementAt(i).accept(this);
            out.print("*");
        }
        me.elementAt(size-1).accept(this);
    }
